...
print("\nWELCOME!\n\n When you want to run the pancake sorting algorithm type"
    + ": 1 \n\n When you want to run the population based algorithm type: 2"
    + "\n\n When you want to run the simulated annealing algorithm type: 3"
...
if algorithm == '2':
    ...
    if default == 'c':
        print("\nDefine the population size you would like the algorithm to"
...
if algorithm == '3':
    ...
    default = input("\n If you want to run the algorithm once with the"
    + " default parameters, type 'd'.\n\n For custom parameters, type 'c'. \n\n"
    + " For running the algorithm (with default parameters) on a test-set with"
    + " 100 random genomes of length 25, type 't'  \n\n")
    ...
    if default == 'd':
        ...
        scoreF = input("Type in which score-funtion that you would like the " +
        "algorithm to use: ")

        if scoreF == '1':
            print("\nDefine the interval with which the algorithm allows"
                + " lesser mutations to pass.\n\nFor an interval of 1000,"
                + "type: s\n For an interval of 10.000, type: m\n For an "
                + "interval of 100.000, type l\n")

            failV = input("Type in which interval-size you would like the"
                        + " algorithm to use: ")
            ...
            print("\nDefine the interval with which the algorithm allows lesser"
